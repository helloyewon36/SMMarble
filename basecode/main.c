...
smm_player_t_smm_players[MAX_PLAYER];
     ...
     for (i=0;i<n;i++)
       {
                ...
                sum_players[i].flag_graduated=0;
...
void actionNode(int player)
{
     ...
     printf("-->player%i pos :%i, type : %s, credit : %i, energy : %i\n", player, smm_players[player].pos, smmObj_getTypeName(type), smm_players[player].credit, smm_players[player].energy); 
     switch(type)
     {
